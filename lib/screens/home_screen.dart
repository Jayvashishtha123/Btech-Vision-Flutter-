...
import 'package:btech_vision/shimmer_efffect/shimmer_effect.dart';
                ...
                Positioned(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          backgroundColor:
                              const Color.fromARGB(255, 237, 190, 190),
                          shape: StadiumBorder(),
                  ...
                  child: Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            Navigator.pushNamed(context, '/quizApp2');
                          },
                          child: Row(
                            children: [
                              SizedBox(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(children: [
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushNamed(context, '/about_cse');
                            },
                            child: Stack(
                              children: [
                                Positioned(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushNamed(context, '/about_ece');
                            },
                            child: Stack(
                              children: [
                                Positioned(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushNamed(context, '/about_ee');
                            },
                            child: Stack(
                              children: [
                                Positioned(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushNamed(context, '/about_civil');
                            },
                            child: Stack(
                              children: [
                                Positioned(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushNamed(context, '/about_mechanical');
                            },
                            child: Stack(
                              children: [
                                Positioned(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(context, '/You_tube');
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                    border: Border.all(
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(context, '/BTechTaskPage');
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                    border: Border.all(
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.pushNamed(context, '/GuessGame');
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                    border: Border.all(
